...
import 'interac_page.dart';
import 'atm_map_page.dart';
import 'login_page.dart';
import 'Transafer_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: const Color.fromARGB(255, 136, 200, 245),
...
class _AccountHomePageState extends State<AccountHomePage> {
  ...
  void addTransaction(String fromAccount, String toAccount, double amount, String description) {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          bottom: const TabBar(
            ...
            tabs: [
              Tab(icon: Icon(Icons.account_balance_wallet,color: Color.fromARGB(255, 255, 255, 250)), text: 'Chequeing'),
              Tab(icon: Icon(Icons.savings,color: Color.fromARGB(255, 250, 250, 250)), text: 'Savings'),
              Tab(icon: Icon(Icons.credit_card,color: Color.fromARGB(255, 253, 254, 250)), text: 'Credit'),
            ],
          ),
          actions: [
            IconButton(
...
class AccountPage extends StatelessWidget {
  ...
  final void Function(String account, double amount, String recipient)? onSendInterac;
  final void Function(String toAccount, double amount, String description)? onAddTransaction;
